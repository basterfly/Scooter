...
//Ученик
    ...
    NSLog(@"%lu %lu", (unsigned long)rangeOfText.location, (unsigned long)rangeOfText.length);
//    NSString *partOneOfText = [text substringToIndex:(NSUInteger)(rangeOfText.length / 2)];
//    NSLog(@"part 1: \n %@", partOneOfText);
//    NSString *partTwoOfText = [text substringFromIndex:(NSUInteger)(rangeOfText.length / 2)];
//    NSLog(@"part 2: \n %@", partTwoOfText);
    

    NSMutableArray *arrayOfStrings = [NSMutableArray new];
    NSString *tempText = text;
    NSRange searchRange = rangeOfText;
    ...
    for ( ; newLocation < tempText.length ; ) {
        ...
        searchRange = [tempText rangeOfString:tempText];
