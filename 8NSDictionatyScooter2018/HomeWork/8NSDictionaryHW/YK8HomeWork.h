...
@interface YK8HomeWork : NSObject
...
/*
 ...
 Алексей, не совсем понятен вопрос 6. Необходимо создать новый дикшинари, только ключем будет являться объект класса Студент?
